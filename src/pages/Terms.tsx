      ...
      content: (
        <>
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-[#2D374B] p-5 rounded-xl border border-purple-500/20"><h4 className="font-bold text-purple-300 mb-3">Statut</h4><p>Apprenti Développeur Full Stack Indépendant</p></div>
